...
const Nav = (props: Props) => {
  ...
  return (
    <div>
      <div className="bg-white x-50"> {/* Set the background color to white */}
        <nav className="flex px-4 border-b  shadow-lg bg-white items-center  w-full">
          <div className="container mx-auto flex content-center items-center ">
            <div className="flex justify-between content-center w-full">
              ...
              <div className="lg:hidden flex items-center content-center">
                <button className="navbar-burger flex items-center justify-center my-auto content-center text-blue-600 py-auto" onClick={toggleNav}>
          ...
          <ul className={`md:px-2 ml-auto md:flex md:space-x-2 bg-white  absolute md:relative font-semibold top-full left-0 h-full right-0 ${isNavOpen ? 'block' : 'hidden'}`}>
            ...
            <li className="bg-white">
              <Link
                ...
                spy={true}
                              ...
                              duration={500}
                              className="flex md:inline-flex p-4 items-center cursor-pointer hover:bg-gray-50 whitespace-nowrap"
              >
                <span>Products</span>
              </Link>
            </li>
